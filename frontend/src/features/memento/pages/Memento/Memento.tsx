  ...
  return (
    <div id="memento-wrapper">
      ...
      <div id="memento-main" className={`${theme}-border-color`}>
        ...
        <br />
        <span id="quote">
          It&apos;s not that we have a short time to live, but that we waste much of it. Life is long enough, and it has
          been given in <br id="quote-break" /> sufficiently generous measure to allow the accomplishment of the very
          greatest things if the whole of it is well invested.
        </span>
