          ...
          { signUp ? 
            <div>
              <form onSubmit={this.createAccount}>
                ...
                <input name="lastName" type="text" placeholder="Last Name" required="required"></input><br />
                <input name="email" type="email" placeholder="Email" required="required"></input><br />
                <input name="password" type="password" placeholder="Password" required="required"></input><br />
                <input name="password2" type="password" placeholder="Password" required="required"></input><br />
